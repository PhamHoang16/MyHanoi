...
class _TourBookingPageState extends State<TourBookingPage> {
  ...
  void calculateTotalPrice() {
    setState(() {
      totalPrice = quantity * widget.tourPrice;
    });
  }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "Thời gian diễn ra: ${widget.tourDateTime}",
                            style: TextStyle(fontSize: 18),
                          ),
                          SizedBox(height: 16),
                          Text(
                            "Địa điểm: ${widget.tourLocation}",
                            style: TextStyle(fontSize: 18),
                          ),
                          SizedBox(height: 16),
                          Text(
